...
const products = [
  ...
  { id:5, name:'Very berry strawberry', image:'Strawberry Macrons Candle.jpeg', mood:'Happy', price:450, priceRange:'mid', burn:'12hr', desc:'Petrichor and soft musk — a gentle companion on quiet, rainy days.', color:'#e3f2fd' },
  { id:6, name:'tiny love buds', image:'Heart Rose.jpeg', mood:'sad', price:299, priceRange:'mid', burn:'42hr', desc:'Smoky vetiver, grey amber, and violet for introspective evenings.', color:'#ede7f6' },
  ...
  { id:11, name:'The Shoreline Shot', image:'Ocean galaxy.jpeg', mood:'spiritual', price:250, priceRange:'budget', burn:'9hr', desc:'Sacred lotus, frankincense, and camphor for meditation and prayer.', color:'#f3e5f5' },
  ...
  { id:18, name:'Wooden candle', image:'Wooden Candles.jpeg', mood:'spiritual', price:1499, priceRange:'premium', burn:'60hr', desc:'Amber, sandalwood, and tuberose — a devotional experience in wax.', color:'#fdf6e3' },
  { id:19, name:'Chai & Chill', image:'Chai biscuit Candle.jpeg', mood:'spiritual', price:199, priceRange:'budget', burn:'4hr+', desc:'Amber, sandalwood, and tuberose — a devotional experience in wax.', color:'#fdf6e3' },
];
