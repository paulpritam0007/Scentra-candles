...
const products = [
  ...
  { id:20, name:'Cinderella Cart', image:'Cinderella's cart.jpeg', mood:'energetic', price:399, priceRange:'mid', burn:'4hr+', desc:'Amber, sandalwood, and tuberose — a devotional experience in wax.', color:'#fdf6e3' },
  { id:18, name:'Roses and Mogra', image:'roses-and-mogra.jpeg', mood:'spiritual', price:450, priceRange:'mid', burn:'4hr+', desc:'Amber, sandalwood, and tuberose — a devotional experience in wax.', color:'#fdf6e3' },
  { id:18, name:'Spooky Friends', image:'Chai biscuit Candle.jpeg', mood:'spiritual', price:199, priceRange:'budget', burn:'4hr+', desc:'Amber, sandalwood, and tuberose — a devotional experience in wax.', color:'#fdf6e3' },
